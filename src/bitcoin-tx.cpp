...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BiYanZu Core biyanzu-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  biyanzu-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded biyanzu transaction") + "\n" +
              "  biyanzu-tx [options] -create [commands]   " + _("Create hex-encoded biyanzu transaction") + "\n" +
              "\n";
