...
### Download the Blockchain from the BiYanZuNode Project

The BiYanZu node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by BiYanZuNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.biyanzunode.org/bootstrap.dat](http://mango.biyanzunode.org/bootstrap.dat)
* [http://apple.biyanzunode.org/bootstrap.dat](http://apple.biyanzunode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.biyanzunode.org/bootstrap.dat](http://bootstrap.biyanzunode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.biyanzunode.org/bootstrap.dat       //downloads bootstrap into current directory
